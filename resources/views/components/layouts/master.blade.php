        ...
        <div class="container">
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    <li class="nav-item"><a class="nav-link" href="docs/alerts.html">News</a></li>
                    <li class="nav-item"><a class="nav-link" href="docs/alerts.html">Solutions</a></li>
                    <li class="nav-item"><a class="nav-link" href="docs/alerts.html">Tips</a></li>
                    <li class="nav-item"><a class="nav-link" href="docs/alerts.html">Packages</a></li>
                </ul>
                <!-- Nav Main menu END -->
            ...
            <div class="dropdown ms-1 ms-lg-0">
                ...
                <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                    ...
                    <li><a class="dropdown-item bg-danger-soft-hover" href="#"><i class="bi bi-power fa-fw me-2"></i>Sign
                            Out</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
