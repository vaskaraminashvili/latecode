<x-layouts.master :header="false" :footer="false">
                        ...
                        <div class="col-sm-10 col-xl-8 m-auto">
                            ...
                            <form method="POST" action="{{route('register.user')}}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" name="name"
                                               ...
                                               placeholder="Name" id="exampleInputName1">
                                    </div>
                                    @error('name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <small>Hint: Password must be at least 6 characters with at least 1 letter.</small>
                                    <br>
                                    @error('password')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
